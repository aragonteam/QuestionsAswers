...
import ProfileScreenBase from '../blur_components/ProfileScreenBase';
...
import ToolbarBlur from '../blur_components/Toolbar';
...
import ProfileBlur from '../blur_components/ProfileBlur';
...
//   setup: function () {
//     RkTheme.theme = RkTheme.themes.classic;
//   }
// };
...
//   setup: function () {
//       RkTheme.theme = RkTheme.themes.material;
//   }
// };
...
let blurTheme = {
  ...
  setup: function () {
    // RkTheme.theme = RkTheme.themes.blur;
    // RkTheme.setTheme(RkTheme.themes.blur);
    var theme = RkTheme.current;
  }
};
...
export default ThemeService = {
  ...
  getProfileScreen: () => blurTheme.profileScreen,
  getToolbarComponent: () => blurTheme.toolbarComponent,
  getProfileComponent: () => blurTheme.profileComponent,
