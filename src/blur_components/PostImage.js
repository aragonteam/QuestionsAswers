...
import {RkModalImg, RkButton, RkStyleSheet, RkText} from 'react-native-ui-kitten';
  ...
  _renderFooter(post) {
    return (
      <View style={styles.footerContainer}>
        ...
        <View style={RkStyleSheet.flex1}>
          <RkButton rkType='clear' style={styles.footerButton} innerStyle={styles.footerIcon}>
            <Icon name={'ios-chatboxes-outline'}/>
          </RkButton>
        </View>
        <View style={RkStyleSheet.flex1}>
          <RkButton rkType="clear" style={RkStyleSheet.transparentBg} innerStyle={RkStyleSheet.transparentText}>Close</RkButton>
        </View>
      </View>
    );
  }
  ...
  _renderHeader(closeImage, post) {
    return (
      <View style={styles.headerContainer}>
        <RkButton innerStyle={RkStyleSheet.whiteText} rkType={'clear'} onPress={closeImage}>Close</RkButton>
