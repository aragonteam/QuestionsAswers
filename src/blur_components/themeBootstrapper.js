...
export let bootstrap = () => {
  ...
  RkTheme.setColor('blurText', 'rgba(255,255,255,0.9)');
  RkTheme.setColor('transparentBg', 'transparent');

  // RkTheme.setType('RkText', 'blurText', {
  //   color: BlurColor.blurTextStrong
  // });
  // RkTheme.setType('RkText', 'transparentBg', {
  //   backgroundColor: 'transparent'
  // });
  // RkTheme.setType('RkText', 'montserrat', {
  //   fontFamily: 'Montserrat-Regular'
  // });

  RkTheme.setType('RkText', 'basic', {
    color: RkTheme.colors.blurText,
    backgroundColor: RkTheme.colors.transparentBg,
    fontFamily: 'Montserrat-Regular'
  });
